...
public class SortPlus {
    ...
    public static void selectionSort(int[] arr) {
        for (int i = 0; i < arr.length - 1; i++) {
            ...
            swap(arr, i, j);
            System.out.println(Arrays.toString(arr) + " :e pass:" + (i+1));
        }
    }
    ...
    public static void insertionSort(int[] arr) {
        for (int i = 1; i < arr.length; i++) {
            ...
            System.out.println(Arrays.toString(arr) + " :e pass:" + (i));
        }
    }
    ...
    public static void bubbleSort(int[] arr) {
        for (int i = arr.length - 1; i > 0; i--) {
            ...
            System.out.println(Arrays.toString(arr) + " :e pass:" + (arr.length - i));
        }
    }
    ...
    private static void mSort(int[] arr, int[] temp, int start, int end) {
        ...
        System.out.println("Start of call " + rand + " ");
        ...
        System.out.println("...end of call " + rand);
    }
